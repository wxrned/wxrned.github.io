...
function createLyricsQuery(track) {
          // Create a mapping of accented characters to their unaccented counterparts
          const accentsMap = {
          ...
          // Normalize the title: lowercase, replace accents, and handle " - "
          const normalizedTitle = track.title
            .toLowerCase()                            // Convert to lowercase
            .replace(/ - /g, ' ')                      // Replace " - " with a space
            .split('')                                 // Split the string into an array of characters
            .map(char => accentsMap[char] || char)     // Replace each character using accentsMap
            .join('');                                 // Join the characters back into a string

          // Add the normalized title as a new property called lyricsQuery
