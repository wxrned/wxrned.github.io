function applyColorsFromImage(imgElementId) {
    const img = document.getElementById(imgElementId); // Ensure the element ID is passed dynamically
    ...
    // Create a canvas to extract the first frame of the image (works for GIFs too)
    ...
    // Extract the dominant color from the image using Color Thief
